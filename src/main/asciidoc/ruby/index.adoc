...
config.put("key.deserializer", Java::OrgApacheKafkaCommonSerialization::StringDeserializer::class)
config.put("value.deserializer", Java::OrgApacheKafkaCommonSerialization::StringDeserializer::class)
