...
# Creating a consumer able to deserialize bytes to Vert.x buffers
consumer = VertxKafkaClient::KafkaConsumer.create(vertx, config, Vertx::Buffer::class, Vertx::Buffer::class)
...
# Creating a producer able to serialize bytes to Vert.x buffers
consumer = VertxKafkaClient::KafkaProducer.create(vertx, config, Vertx::Buffer::class, Vertx::Buffer::class)
