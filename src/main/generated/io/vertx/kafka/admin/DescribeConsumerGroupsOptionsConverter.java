...
public class DescribeConsumerGroupsOptionsConverter {
  ...
  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, DescribeConsumerGroupsOptions obj) {
  ...
  public static void toJson(DescribeConsumerGroupsOptions obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(DescribeConsumerGroupsOptions obj, java.util.Map<String, Object> json) {
  }
}
